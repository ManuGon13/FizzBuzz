...
SRCS		= src/main.c \
			...
			src/execution/execution_has_redirection.c \
			src/execution/execution_close.c \
			...
			src/execution/execution_process_helpers.c \
			src/execution/execution_process_helpers2.c \
